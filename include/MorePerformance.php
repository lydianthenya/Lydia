                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            if(mysqli_num_rows($query)>0){
                                $queryuserdetails=mysqli_query($con,"select * from Users where UserId='$userid'");
                                $dataresult=mysqli_fetch_array($queryuserdetails);
                                echo "<b>Name:</b> ". $dataresult['FirstName']."&nbsp". $dataresult['SecondName']."&nbsp;&nbsp;&nbsp;";
                                echo "<b>Email:</b> ".$dataresult['Email']."&nbsp;&nbsp;&nbsp;";
                                echo "<b>Phone Number:</b> ".$dataresult['Phone']."<br><br>";
                                ?>
